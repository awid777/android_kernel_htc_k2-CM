...
static struct clk_freq_tbl clk_tbl_gfx3d[] = {
	...
	F_GFX3D(430000000, pll2,  1,  2),
	F_GFX3D(455000000, pll15, 1,  2),
	F_END
};
...
static struct rcg_clk vcap_clk = {
	...
	.c = {
		...
		VDD_DIG_FMAX_MAP2(LOW, 100000000, NOMINAL, 210000000),
		CLK_INIT(vcap_clk.c),
	},
};
...
static struct rcg_clk jpegd_clk = {
	...
	.c = {
		.dbg_name = "jpegd_clk",
		.ops = &clk_ops_rcg,
		VDD_DIG_FMAX_MAP2(LOW, 96000000, NOMINAL, 210000000),
...
static struct rcg_clk rot_clk = {
	...
	.c = {
		.dbg_name = "rot_clk",
		.ops = &clk_ops_rcg,
		VDD_DIG_FMAX_MAP2(LOW, 96000000, NOMINAL, 220000000),
		CLK_INIT(rot_clk.c),
